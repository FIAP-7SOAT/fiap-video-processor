...
class VideoProcessingService(
    ...
    private fun extractImagesUsingJavaCV(videoPath: String, imagesDir: String) {
        ...
        grabber.setVideoCodec(avcodec.AV_CODEC_ID_H264) // Código corrigido ✅
        grabber.start()
